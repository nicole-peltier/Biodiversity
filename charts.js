...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var filterSample = samples.filter(obj => obj.id == sample);
    ...
    // Create the variable that holds the first sample in the metadata array
    var firstMetaData = metadataArray[0];

    // Create a variable that holds the washing frequency
    var washingFreq = parseInt(firstMetaData.wfreq);
